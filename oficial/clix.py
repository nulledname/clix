...
winsound.PlaySound("welcome", winsound.SND_FILENAME) # En la carpeta "Voces/" se encuentran todos los archivos de voz.
bienvenido = input("Como es tu nombre.? ")
winsound.PlaySound("encantado", winsound.SND_FILENAME ) # En la carpeta "Voces/" se encuentran todos los archivos de voz.
print ("bienvenido " + bienvenido)
dialogo = input("Que deseas hacer?. ")
print (dialogo)
winsound.PlaySound("opciones", winsound.SND_FILENAME) # En la carpeta "Voces/" se encuentran todos los archivos de voz.
...
while not salir: # Mostramos las opciones disponibles.
    ...
    if opcion == 1: # Opcion 1 muestra sub opciones.
        ...
        while not salir:
            ...
            query = input('Buscar una cancion: ') # Ingresar busqueda.
            query = query.replace(' ', '+')         

            # buscar el mejor video similar que coincida
            ...
            link = song['href']
            webbrowser.open('https://www.youtube.com' + link) # Abre web browser por defecto y carga la pagina de youtube junto la busqueda realizada anteriormente.
...
winsound.PlaySound("adios", winsound.SND_FILENAME)